    ...
    <div style={{
      ...
      <div className="fade-up" style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: "#111", border: "1px solid #1e1e1e", borderRadius: 20, padding: "2.5rem" }}>
          <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2rem", letterSpacing: "0.04em", marginBottom: "0.5rem" }}>Welcome Back</h2>
          <p style={{ color: "#555", fontSize: "0.875rem", marginBottom: "2rem" }}>Sign in to continue your grind</p>
          ...
          <p style={{ textAlign: "center", marginTop: "1.5rem", color: "#555", fontSize: "0.875rem" }}>
            No account?{" "}
            <Link to="/signup" style={{ color: "#c8f135", fontWeight: 600 }}>Create one</Link>
          </p>
        </div>
      </div>
    </div>
